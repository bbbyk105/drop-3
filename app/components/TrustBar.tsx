const items = [
  {
    ...
    subtitle: "Science-backed ingredients",
  },
  {
    icon: (
      <svg
    ...
    subtitle: "Guaranteed substance-free",
  },
  {
    icon: (
      <svg
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-6 md:grid-cols-3 lg:px-8">
        {items.map((item) => (
          ...
          >
            ...
            <h3 className="mt-3 text-sm font-semibold uppercase tracking-wide text-black">
              {item.title}
            </h3>
