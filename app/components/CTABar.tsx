const items = [
  {
    ...
    title: "SUBSCRIBE & SAVE 25% + FREE SHIPPING",
    subtitle:
      "Get your favorite products delivered right to your door, and save money while you're at it.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    subtitle:
      "Share the love and get rewarded. Refer a friend and both of you get 20% off your next order.",
  },
];
